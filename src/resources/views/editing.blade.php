    ...
    <div class="profile-form__inner">
        <form class="profile-form__form" action="/mypage/profile" method="post" enctype="multipart/form-data">
            ...
            <div class="profile-form__group--img">
                @if ($user->image_path)
                <img class="profile-form__img" id="preview" src="{{ Storage::url($user->image_path) }}" alt="プロフィール画像">
                @else
                <img class="profile-form__img" id="preview" src="{{ asset('img/default_icon.png') }}" alt="NoImage">
                @endif
